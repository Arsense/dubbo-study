...
import com.tw.dubbo.common.utils.ArrayUtils;
...
public class ActivateComparator implements Comparator<Object> {
    ...
    private ActivateInfo parseActivate(Class<?> clazz) {
        ...
        if (clazz.isAnnotationPresent(Activate.class)) {
            ...
            com.tw.dubbo.common.extension.Activate activate = clazz.getAnnotation(
                    com.tw.dubbo.common.extension.Activate.class);
            info.before = activate.before();
            info.after = activate.after();
            info.order = activate.order();
        }
